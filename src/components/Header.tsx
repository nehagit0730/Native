          ...
          {googleUser ? (
            ...
            <div className="flex items-center space-x-1.5">
              <button
                ...
                className="flex items-center space-x-1.5 bg-white hover:bg-slate-50 border border-slate-300 text-slate-800 font-extrabold text-xs px-3 py-2 rounded-xl shadow-xs transition-all cursor-pointer"
              >
